...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fuel_distributes', function (Blueprint $table) {
            ...
            $table->integer('distribution_type')->default(1); // 1: with_request, 2: direct_distribution
            ...
            $table->foreignId('fuel_request_reason_id')->nullable()->constrained()->onDelete('restrict');
